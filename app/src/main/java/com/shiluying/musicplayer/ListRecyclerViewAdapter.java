...
import com.shiluying.musicplayer.ListFragment.OnListFragmentInteractionListener;
...
public class ListRecyclerViewAdapter extends RecyclerView.Adapter<ListRecyclerViewAdapter.ViewHolder> {
    ...
    public ListRecyclerViewAdapter(List<MusicItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
